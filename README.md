...
Uma API desenvolvida em **.NET 10** para gerenciar o ciclo de vida e a manutenção de equipamentos de mina (caminhões fora-de-estrada, escavadeiras, perfuratrizes, etc.).
